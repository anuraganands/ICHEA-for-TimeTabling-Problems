...
How to run:
1 - The program runs on Netbeans. It is old and relies on Swing Framework. You will need to add appframework-1.0.3.jar and swing-worker.jar into your project. Both jar files are available in the main folder. You may also need matlabcontrol-4.0.0.jar file.
